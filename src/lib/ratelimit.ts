 ...
 *
 * IMPORTANT — honest framing: this is BEST-EFFORT. On Vercel (and any
 * serverless platform) each function instance has its own Map; the limit
 * resets on cold start and isn't shared across concurrently-scaled instances.
 *
 ...
 *
 * Upgrade path: swap the Map for Upstash Redis or Vercel KV via
